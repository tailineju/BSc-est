...
pdde_pagos <- read_csv2("pdde_pagos.csv", skip = 5)
pdde_naopagos <- read_csv2("pdde_naopagos.csv", skip = 5)
...
dados <- censo23_co %>% left_join(pdde, by = c("CO_ENTIDADE" = "Código Escola"))
