...
plot(rho, main = "Função de autocorrelação com lag=36", xlab = "Lag", ylab = "ACF")
```
...
plot(phi, main = "Função de autocorrelação parcial", xlab = "Lag", ylab = "PACF", lwd = 3)
```
...
plot(phi, main = "Função de autocorrelação parcial com lag=36", xlab = "Lag", ylab = "PACF", lwd = 3)
```
...
plot(phi, main = "Função de autocorrelação parcial", xlab = "Lag", ylab = "PACF")
```
