...
pacman::p_load(vroom,tidyverse, knitr)#, kableExtra, lme4, gridExtra, clipr, corrplot)
...
df %>%
    ...
    ylim(100,400)+
    theme_tcc()
ggsave("EDA/img/boxplot_lp_nse.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_nse.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_area.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_area.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_loc.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_loc.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_raca.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_raca.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_mae.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_mae.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>%
  ...
  ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_tempo.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_tempo.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_reprovacao.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_reprovacao.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_abandono.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_abandono.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>% 
  ...
  ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_lazer.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_lazer.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>% 
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_cursos.pdf", width = 8, height = 5, dpi = 300)
...
df %>% 
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_cursos.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>% 
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_domesticos.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_domesticos.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>%
   ...
   mutate(TX_RESP_Q017D = case_when(
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_estudo.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc() 
ggsave("EDA/img/boxplot_mt_estudo.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_trabalho.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_trabalho.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_noticias.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_noticias.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_livros.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_livros.pdf", width = 8, height = 5, dpi = 300)
```
...
df %>%
    ...
    ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_lp_quadrinhos.pdf", width = 8, height = 5, dpi = 300)
...
df %>%
  ...
  ylim(100,400)+
  theme_tcc()
ggsave("EDA/img/boxplot_mt_quadrinhos.pdf", width = 8, height = 5, dpi = 300)
```
