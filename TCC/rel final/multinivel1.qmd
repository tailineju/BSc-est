...
pacman::p_load(vroom,tidyverse, knitr, openxlsx, kableExtra, lmerTest, gridExtra, clipr,lattice,nlme,lme4)
options(OutDec = ",")
...
#modelo nulo
modelo_nulo <- lmerTest::lmer(PROFICIENCIA_LP_SAEB ~ 1 + (1|ID_ESCOLA), data = df_used)
summary(modelo_nulo)
