...
df %>%
    ...
    labs(x = "Localização da Escola",
         y = "Língua Portuguesa") +
    theme_minimal()
ggsave("img/boxplot_lp_loc.pdf", width = 15, height = 10, dpi = 300)
...
df %>%
    ...
    labs(x = "Localização da Escola",
         y = "Matemática") +
    theme_minimal()
ggsave("img/boxplot_mt_loc.pdf", width = 15, height = 10, dpi = 300)
```
...
df %>%
    ...
    labs(x = "Tempo para chegar a escola",
         y = "Língua Portuguesa") +
    theme_minimal()
ggsave("img/boxplot_lp_tempo.pdf", width = 15, height = 10, dpi = 300)
